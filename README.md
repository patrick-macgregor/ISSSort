...
use iss_sort with following flags:
        ...
        [-relcal         <string        >: Make the array calibration plots with pid and nid as the reference strips, given in the string format p<pid>n<nid>]
        [-print-settings                 : Print settings]
        [-spy                            : Flag to run the DataSpy]
        [-spyhists       <string        >: File containing histograms for monitoring in the spy]
